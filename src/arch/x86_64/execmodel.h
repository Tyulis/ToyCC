...
namespace toycc::arch::x86_64 {
    enum class LOC : std::size_t {
        ...
        MEMORY = 0x4000000000000000, OFFSET_MEMORY = 0x8000000000000000,
    };
    ...
    constexpr Flags<LOC> MEMORY = LOC::MEMORY | LOC::OFFSET_MEMORY;
    ...
    extern const std::unordered_map<ir::StatementTag, StatementIO> STATEMENT_IO;
}
