...
namespace toycc::ir {
    ...
    private:
        ...
        std::shared_ptr<Declaration> decode_initializer(CParser::InitializerContext* context);
        std::shared_ptr<Declaration> decode_expression(CParser::ExpressionContext* context);
        std::shared_ptr<Declaration> decode_assignment_expression(CParser::AssignmentExpressionContext* context);
        std::shared_ptr<Declaration> decode_conditional_expression(CParser::ConditionalExpressionContext* context);
        std::shared_ptr<Declaration> decode_logical_or_expression(CParser::LogicalOrExpressionContext* context);
        std::shared_ptr<Declaration> decode_logical_and_expression(CParser::LogicalAndExpressionContext* context);
        std::shared_ptr<Declaration> decode_inclusive_or_expression(CParser::InclusiveOrExpressionContext* context);
        std::shared_ptr<Declaration> decode_exclusive_or_expression(CParser::ExclusiveOrExpressionContext* context);
        std::shared_ptr<Declaration> decode_and_expression(CParser::AndExpressionContext* context);
        std::shared_ptr<Declaration> decode_equality_expression(CParser::EqualityExpressionContext* context);
        std::shared_ptr<Declaration> decode_relational_expression(CParser::RelationalExpressionContext* context);
        std::shared_ptr<Declaration> decode_shift_expression(CParser::ShiftExpressionContext* context);
        std::shared_ptr<Declaration> decode_additive_expression(CParser::AdditiveExpressionContext* context);
        std::shared_ptr<Declaration> decode_multiplicative_expression(CParser::MultiplicativeExpressionContext* context);
        std::shared_ptr<Declaration> decode_cast_expression(CParser::CastExpressionContext* context);
        std::shared_ptr<Declaration> decode_unary_expression(CParser::UnaryExpressionContext* context);
        std::shared_ptr<Declaration> decode_postfix_expression(CParser::PostfixExpressionContext* context);
        std::shared_ptr<Declaration> decode_primary_expression(CParser::PrimaryExpressionContext* context);
        std::shared_ptr<Declaration> decode_function_call(std::shared_ptr<Declaration> function, CParser::PostfixOperatorContext* call);
